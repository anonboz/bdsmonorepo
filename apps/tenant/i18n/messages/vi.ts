  ...
  bills: {
    ...
    detail: {
      ...
      pay: {
        ...
        subtitle: "Còn nợ: {amount}. Chọn phương thức thanh toán.",
        noMethods: "Chủ nhà chưa thiết lập phương thức thanh toán. Vui lòng liên hệ chủ nhà.",
        cash: "Tiền mặt",
        cashDefault: "Thanh toán tiền mặt cho chủ nhà hoặc quản lý tòa nhà.",
        ...
        copy: "Sao chép",
        copied: "Đã chép",
        qrAlt: "Mã VietQR cho hóa đơn này",
        scanHint: "Quét bằng ứng dụng ngân hàng. Số tiền và nội dung đã được điền sẵn.",
        card: "Thẻ",
        ewallet: "Ví điện tử",
        points: "Điểm thưởng",
