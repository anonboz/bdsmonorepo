...
// so the first paint is right, then kept fresh by polling (there's no push or
// realtime channel yet). The inbox page invalidates UNREAD_COUNT_QUERY_KEY
// after marking rows read so the badge drops immediately.
