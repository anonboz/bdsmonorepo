...
const NAV: NavItem[] = [
  ...
  { href: '/my-tickets', key: 'tickets', icon: Wrench },
  { href: '/browse', key: 'browse', icon: Search },
  { href: '/me/applications', key: 'applications', icon: ClipboardList },
  { href: '/notifications', key: 'notifications', icon: Bell },
  { href: '/me', key: 'account', icon: Settings },
];
...
/**
 * Persistent tenant navigation. Slide-in drawer with a top bar on mobile
 * (tenant is mobile-first per apps/tenant/CLAUDE.md); a fixed left rail on
 * >=1024px. Wraps all `(authed)` routes via the layout. Labels are localized
 * via @repo/i18n.
 */
export function Sidebar({ userName }: { userName: string }) {
  ...
  const tChrome = useTranslations('tenant.chrome');
