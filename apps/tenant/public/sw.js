  ...
  var e = {
      409: (e) => {
        ...
        var o = [],
          ...
          h = -1;
        function u() {
          l && s && ((l = !1), s.length ? (o = s.concat(o)) : (h = -1), o.length && d());
        }
        function d() {
          if (!l) {
            var e = c(u);
        ...
        ((r.nextTick = function (e) {
          ...
          (o.push(new m(e, t)), 1 !== o.length || l || c(d));
        }),
  ...
  (() => {
    ...
    function P(e, t) {
      ...
      let a = t.replace(/FromIndex$/, ''),
        s = t !== a,
        r = D.includes(a);
      if (!(a in (s ? IDBIndex : IDBObjectStore).prototype) || !(r || T.includes(a))) return;
    ...
    E = ((e) => ({
      ...e,
      get: (t, a, s) => P(t, a) || e.get(t, a, s),
      has: (t, a) => !!P(t, a) || e.has(t, a),
    }))(E);
    let C = ['continue', 'continuePrimaryKey', 'advance'],
      A = {},
      k = new WeakMap(),
      I = new WeakMap(),
      L = {
        get(e, t) {
          if (!C.includes(t)) return e[t];
          let a = A[t];
          return (
            a ||
              (a = A[t] =
    ...
    E = ((e) => ({
      ...e,
      get: (t, a, s) => (F(t, a) ? U : e.get(t, a, s)),
      has: (t, a) => F(t, a) || e.has(t, a),
    }))(E);
    let O = async (e, t) => {
        let s = null;
    ...
    var Q = class {
        ...
        async getAll() {
          ...
          for (let s of e) {
            ...
            t - s.timestamp > e ? await this._queueStore.deleteEntry(s.id) : a.push(V(s));
          }
          return a;
        }
        async size() {
        ...
        async _removeRequest(e) {
          ...
          if (t) {
            ...
            return a - t.timestamp > s ? this._removeRequest(e) : V(t);
          }
        }
    ...
    var ed = class {
      ...
      ef = class {
        ...
        _getCacheExpiration(e) {
          if (e === c.getRuntimeName()) throw new l('expire-custom-caches-only');
    ...
    let eg = /^\/(\w+\/)?collect/,
      ep = ({ serwist: e, cacheName: t, ...a }) => {
        let s = c.getGoogleAnalyticsName(t),
          r = new z('serwist-google-analytics', {
      ...
      eR = class {
        ...
        constructor({
          ...
          if (
            ...
            void 0 !== n && ((m = { prefix: n }), c.updateDetails(m)),
            a
              ? self.skipWaiting()
            ...
            y.cleanupOutdatedCaches &&
              ...
              self.addEventListener('activate', (e) => {
                e.waitUntil(w(c.getPrecacheName(f)).then((e) => {}));
              })),
            ...
            void 0 !== l &&
              ('boolean' == typeof l ? l && ep({ serwist: this }) : ep({ ...l, serwist: this })),
            void 0 !== o)
          ) {
            if (void 0 !== u) {
      ...
      eT =
        ...
        (o = (function a(s) {
          ...
          var n = (t[s] = { exports: {} }),
            i = !0;
          try {
            (e[s](n, n.exports, a), (i = !1));
          } finally {
            i && delete t[s];
          }
          return n.exports;
        })(409).env.NEXT_PUBLIC_API_URL)
          ? o
          : 'http://localhost:3001';
    new eR({
      precacheEntries: [
        { revision: null, url: '/_next/static/chunks/23-bad6375feff1f0b2.js' },
        { revision: null, url: '/_next/static/chunks/238.5a786b2cea582a5b.js' },
        { revision: null, url: '/_next/static/chunks/555.e21acc4e9cd0b013.js' },
        { revision: null, url: '/_next/static/chunks/586-7cf75410a7d55221.js' },
        { revision: null, url: '/_next/static/chunks/912-d275daeedc974f86.js' },
        { revision: null, url: '/_next/static/chunks/app/(authed)/layout-8dbae88783c71e06.js' },
        { revision: null, url: '/_next/static/chunks/app/(authed)/page-9244d87fb1669498.js' },
        { revision: null, url: '/_next/static/chunks/app/_not-found/page-99bbee332bf03f0b.js' },
        { revision: null, url: '/_next/static/chunks/app/forbidden/page-67b0f7155319a503.js' },
        { revision: null, url: '/_next/static/chunks/app/layout-8a22f01441c21621.js' },
        { revision: null, url: '/_next/static/chunks/app/login/page-d78ee919b3c7c1d4.js' },
        { revision: null, url: '/_next/static/chunks/app/offline/page-2a49b5955be1d2ea.js' },
        { revision: null, url: '/_next/static/chunks/bb811a4c-806c47b5980e1adb.js' },
        { revision: null, url: '/_next/static/chunks/framework-1c02a2e60068b586.js' },
        { revision: null, url: '/_next/static/chunks/main-23697ce5311f1f6a.js' },
        { revision: null, url: '/_next/static/chunks/main-app-246f5f8b2b70118d.js' },
        { revision: null, url: '/_next/static/chunks/pages/_app-460d75d0ef20eee9.js' },
        { revision: null, url: '/_next/static/chunks/pages/_error-f91659dcc8e34e2b.js' },
        {
          revision: '846118c33b2c0e922d7b3a7676f81f6f',
          url: '/_next/static/chunks/polyfills-42372ed130431b0a.js',
        },
        { revision: null, url: '/_next/static/chunks/webpack-ae07369347e3a967.js' },
        { revision: null, url: '/_next/static/css/3ade028623533415.css' },
        {
          revision: '02ac7bb0e05cb65a0b6a9817b305193c',
          url: '/_next/static/vMIpkjoxX23-3ZHt3aR9b/_buildManifest.js',
        },
        {
          revision: 'b6652df95db52feb4daf4eca35380933',
          url: '/_next/static/vMIpkjoxX23-3ZHt3aR9b/_ssgManifest.js',
        },
        { revision: 'd0940eafa039580c3eb43cf232658603', url: '/icons\\icon-maskable.svg' },
        { revision: 'f3dea51863f527d5f55f382e1b4a42a7', url: '/icons\\icon.svg' },
        { revision: '52a15b0fbef57f6aaf617b1092c766b7', url: '/manifest.webmanifest' },
      ...
      runtimeCaching: [
        {
          matcher: (e) => {
            ...
            return 'GET' === a.method && t.origin === new URL(eT).origin;
          },
          handler: new ee({
            cacheName: 'api-cache',
            networkTimeoutSeconds: 5,
            plugins: [new ef({ maxEntries: 64, maxAgeSeconds: 86400 })],
          }),
        },
        {
          matcher: (e) => {
            let { request: t } = e;
            return ['style', 'script', 'worker', 'image', 'font'].includes(t.destination);
          },
          handler: new ev({
            cacheName: 'asset-cache',
            plugins: [new ef({ maxEntries: 128, maxAgeSeconds: 2592e3 })],
          }),
        },
        {
          ...
          handler: new ex({
            ...
            plugins: [new ef({ maxEntries: 64, maxAgeSeconds: 2592e3 })],
          }),
        },
        ...eS,
      ],
