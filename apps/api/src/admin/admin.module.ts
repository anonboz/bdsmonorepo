...
@Module({
  controllers: [AdminUsersController, AdminHousesController, AdminAuditController],
  providers: [AdminUsersService, AdminHousesService, AdminAuditService, AuditLogger],
  exports: [AuditLogger],
})
