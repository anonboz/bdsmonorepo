...
function resolveHref(notification: Notification): string | null {
  // Partner only receives payout.disbursed for now; payouts has no
  // per-entry detail page in v1 (the list shows the bank reference).
  if (notification.topic === 'payout.disbursed') return '/payouts';
  return null;
}
